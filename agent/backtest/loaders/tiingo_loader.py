...
def throttled_get_json(
    ...
    *,
    ...
    if tiered_http_get is None:
        raise RuntimeError("trade_integrations.tiered_api is required for tiingo loader")
    return tiered_http_get("tiingo", url, params=params or {}, credential_param="token")
