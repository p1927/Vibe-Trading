...
``docs/DECISIONS.md`` D29): ``NIFTY``, ``NIFTY50`` and ``^NSEI`` are one index,
...
spelling authority, which D29 forbids.
...
matchers — the pre-D29 behaviour. Once the Trade stack is found, an import
