...
# ============================================================================
#
# Extracted to sse_frames.py per docs/FORK_CONVENTIONS.md — these are pure
# functions of event/session_id with no route-registration dependency.
# Re-imported here (not just called) because agent/api_server.py imports
