...
- **2026-07-06** 🧭 **Preflight hardening, API slices, CN search fallback, and artifact traces**: provider preflight는 이제 redirect를 따라가지 않고([#404](https://github.com/HKUDS/Vibe-Trading/pull/404), [#402](https://github.com/HKUDS/Vibe-Trading/issues/402) 닫힘, @SyntaxSawdust 님 감사합니다), 남은 API routes는 focused modules로 이동했습니다([#387](https://github.com/HKUDS/Vibe-Trading/pull/387), [#383](https://github.com/HKUDS/Vibe-Trading/pull/383)-[#386](https://github.com/HKUDS/Vibe-Trading/pull/386) supersede, @shadowinlife 님 감사합니다). CN web-search fallback은 Alibaba Cloud IQS를 포함하고([#408](https://github.com/HKUDS/Vibe-Trading/pull/408), @sambazhu 님 감사합니다), artifact traces에는 metadata refs가 추가됐습니다([#406](https://github.com/HKUDS/Vibe-Trading/pull/406), @Elfsa-Miranda 님 감사합니다). Maintainer cleanup으로 no-network fallback tests와 EOF whitespace cleanup도 추가했습니다([fbac74f](https://github.com/HKUDS/Vibe-Trading/commit/fbac74f77bfed58dd7fc23d0f001c29190b4b2b6)); main CI는 green입니다([run 28780619018](https://github.com/HKUDS/Vibe-Trading/actions/runs/28780619018)).
