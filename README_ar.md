...
| `/skills` | عرض جميع مهارات التداول الـ 72 |
...
جميع مهارات التداول الـ 72 منشورة على [open-space.cloud](https://open-space.cloud) وتتطور بشكل مستقل عبر محرك التطور الذاتي من OpenSpace.
...
سيكتشف OpenSpace تلقائياً جميع المهارات الـ 72، مما يتيح الإصلاح التلقائي والتحسين التلقائي والمشاركة المجتمعية. ابحث عن مهارات Vibe-Trading عبر `search_skills("finance backtest")` في أي وكيل متصل بـ OpenSpace.
...
│   │   │   ├── skills.py           #   محمل المهارات (72 مدمجة + إنشاء CRUD من المستخدم)
