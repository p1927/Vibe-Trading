  ...
  return (
    <div className="space-y-4">
      <p className="text-[11px] text-muted-foreground">
        ...
        <code className="rounded bg-muted px-1 py-0.5">FactorCategory.ECONOMY</code> series — IMF/
        World Bank annual data or FRED monthly data, mixed cadence per market. A market with no
        confirmed source for the selected factor shows "Not sourced" instead of a blank line.
      </p>
      ...
      <div className="flex flex-wrap items-center gap-2">
        ...
        <span className="text-[11px] text-muted-foreground">{activeFactor.unit}</span>
      </div>
